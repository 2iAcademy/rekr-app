...
| **Télétravail** | Filtre sur ce que le candidat peut *tenir*, pas sur une égalité. Voir `REMOTE_AFFINITY`. Ne s'applique que s'il a répondu. |
...
l'emporte, et une offre n'est exclue que si *tous* ses contrats l'excluent.
...
Camille, candidate de l'environnement QA : **Informatique**, confirmée, cherche un
