...
// Cardinality cap shared by candidate skills, offer skills and company
// benefits. Well above any realistic profile, low enough that a single request
// cannot turn the tag table into a write amplifier.
